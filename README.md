...
1. Download the [POPScomp *Docker* image](https://hub.docker.com/u/popscomp) and run the *Shiny* App on your local computer.
2. To install from source code, either download the [latest release](https://github.com/Fraternalilab/POPScomp/releases/latest) or the development version by cloning this POPScomp repository.
